...
- hours: only relevant when entryType is "hours" — a plain number (e.g. 2.5). If only a time range is given (e.g. "9:00-11:30"), compute the duration. Use 0 for expense entries.
